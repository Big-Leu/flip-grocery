<ul class="B7XK2X">
  <li class="XGZdnG">
    <a class="IKoe2r" href="/communication-preferences/push?t=all">
      <svg
      ...
      <div class="qstlfY">Notification Preferences</div>
    </a>
  </li>
  <li class="XGZdnG">
    <a
      href="https://seller.flipkart.com/?utm_source=flipkart&amp;utm_medium=website&amp;utm_campaign=sellbutton"
      class="IKoe2r"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="qstlfY">Become a Seller</div>
    </a>
  </li>
  <li class="XGZdnG">
    <a class="IKoe2r" href="/helpcentre">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
      ...
      <div class="qstlfY">24x7 Customer Care</div>
    </a>
  </li>
  <li class="XGZdnG">
    <a
    ...
    >
      ...
      <div class="qstlfY">Advertise</div>
    </a>
  </li>
  <li class="XGZdnG">
    <a class="IKoe2r" href="/mobile-apps?otracker=ch_vn_mobile_apps">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="14"
      ...
      <div class="qstlfY">Download App</div>
    </a>
  </li>
</ul>;
